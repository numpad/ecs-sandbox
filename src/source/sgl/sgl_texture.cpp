...
#include <stdio.h>
bool sgl::texture::load(int width, int height, sgl::texture::internalformat internal_format, void *data, sgl::texture::format loader_format, sgl::texture::datatype dtype) {
