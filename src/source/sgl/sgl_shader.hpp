...
private:
	...
	GLenum type_to_gl_shader[sgl::shader::MAX_TYPES] = {GL_VERTEX_SHADER, GL_FRAGMENT_SHADER, GL_GEOMETRY_SHADER};

	std::string type_to_name[sgl::shader::MAX_TYPES] = {"vertex", "fragment", "geometry"};
