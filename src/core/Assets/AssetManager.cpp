...
std::vector<Texture*> AssetManager::convertAndCollectMaterialTextures(aiMaterial* mat, aiTextureType type,
...
Mesh* AssetManager::convertAndCollectMesh(aiMesh* mesh, const aiScene* scene) {
	...
	if (mesh->mMaterialIndex >= 0) {
		...
		std::vector<Texture*> diffuseTextures =
		    convertAndCollectMaterialTextures(material, aiTextureType_DIFFUSE, Texture::UsageType::DIFFUSE);

		textures.insert(textures.end(), diffuseTextures.begin(), diffuseTextures.end());
		// specular
		std::vector<Texture*> specularTextures =
		    convertAndCollectMaterialTextures(material, aiTextureType_SPECULAR, Texture::UsageType::SPECULAR);

		textures.insert(textures.end(), specularTextures.begin(), specularTextures.end());
		// normal
		std::vector<Texture*> normalTextures =
		    convertAndCollectMaterialTextures(material, aiTextureType_NORMALS, Texture::UsageType::NORMAL);
