...
public:
	...
	enum class filter : GLenum {
		...
		linear_linear = GL_LINEAR_MIPMAP_LINEAR, /**< Uses the weighted average of the nearest 4 pixels and the weighted
		                                            average of the nearest 2 mipmaps. */
		nearest_linear =
		    GL_NEAREST_MIPMAP_LINEAR, /**< Uses the nearest pixel and the weighted average of the nearest 2 mipmaps. */
		linear_nearest =
		    GL_LINEAR_MIPMAP_NEAREST /**< Uses the weighted average of the nearest 4 pixels and the nearest mipmap. */
	};
