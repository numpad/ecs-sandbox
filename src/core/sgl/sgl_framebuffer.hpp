...
public:
	...
	void attach(sgl::texture& texture, sgl::attachment attachment,
	            framebuffer::target target = framebuffer::target::both);
	void attach(sgl::renderbuffer& renderbuffer, sgl::attachment attachment,
	            framebuffer::target target = framebuffer::target::both);
