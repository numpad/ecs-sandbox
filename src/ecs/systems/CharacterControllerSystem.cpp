...
CharacterControllerSystem::CharacterControllerSystem(entt::registry& registry, GLFWwindow* window,
...
void CharacterControllerSystem::update(float dt) {
	...
	registry.view<CPosition, CVelocity, const CKeyboardControllable>().each(
	    [this, viewDir](auto entity, auto& pos, auto& vel, const auto& controller) {
